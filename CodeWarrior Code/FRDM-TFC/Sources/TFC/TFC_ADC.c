...
{
    return (((float)BatSenseADC_Value/(float)(ADC_MAX_CODE)) * 3.3f * 5.745f);// ME: 5.745 manually tuned from the basic divider 5.7 using accurate multimeter for comparison
}
